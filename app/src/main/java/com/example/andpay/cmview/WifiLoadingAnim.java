package com.example.andpay.cmview;/**
...
public class WifiLoadingAnim extends View implements View.OnClickListener{
    ...
    private void initPaint() {
        ...
        mPaint.setColor(Color.parseColor("#b23d434b"));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setStrokeWidth(mWidth / signalSize * 8);
